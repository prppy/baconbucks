...
SECRET_KEY = 'django-insecure-*l3-&&^@0u5m0fxo@-0z5rg9i!vv#q%6$83352k!6dnp(%10mf'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['backonbucks-05fec980cd2b.herokuapp.com', 'localhost', '127.0.0.1']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'd6ne7b9ejdgfu1',
        'USER': 'u6h29mqmdhu0pb',
        'PASSWORD': 'p949383855318e69634159b7366164aa7e7e56792356c02d29eb7d9cd1873945b',
