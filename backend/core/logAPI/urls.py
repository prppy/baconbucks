...
from .views import TransactionCreateView, TransactionDetailView, TransactionListView, TransactionDeleteView, TransactionUpdateView, ReminderCreateView, ReminderDetailView, ReminderDeleteView, ReminderUpdateView
